...
# Repositori Tugas Basis Data 2024
...
2. **Clone** repositori hasil **fork** anda
   ...
   git clone https://github.com/YOUR_USERNAME/LAB-BASDAT-2024.git
...
8. Setelah asistensi dan tugas anda disetujui, **push** seluruh _file_ jawaban yang telah anda buat
   ...
   #6. Tuliskan note untuk token anda (ex: Token for LAB-BASDAT-2024)
